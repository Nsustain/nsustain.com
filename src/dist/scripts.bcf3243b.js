...
h1.textContent = 'An h1 element with JavaScript.'; // Example of event handlers.
...
function promptForUserName() {
  userName = prompt('Enter your user name.'); // The API localStorage stores userName in the browser.

  localStorage.setItem('userName', userName);
  h2.textContent = TEXT_h2 + userName; // Example of using localStorage.getItem(...)
